          ...
          <footer className="w-full border-t bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
              <div className="mb-2 md:mb-0 flex items-center space-x-2">
                <span>&copy; {new Date().getFullYear()} Sangha Rides. All rights reserved.</span>
                <span className="text-gray-400" aria-hidden="true">&middot;</span>
                <a href="/about" className="hover:text-amber-600">Made with <span role="img" aria-label="love">❤️</span> in Montreal</a>
              </div>
