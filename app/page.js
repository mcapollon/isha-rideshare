      ...
      <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div className="px-6 pt-10 pb-24 sm:pb-32 lg:col-span-7 lg:px-0 lg:pt-40 lg:pb-48 xl:col-span-6">
          <div className="mx-auto max-w-lg lg:mx-0">
            ...
            Looking for a convenient and eco-friendly way to travel to Isha programs? Whether you’re heading to major Isha Yoga Centers or attending smaller Hatha Yoga sessions near you, our platform helps you find and share rides with others on the same journey. Experience seamless travel while building connections with like-minded individuals.
            </p>
